...
TABELA_DESC = {
    ...
    "SLV_MUNICIPIO":   "dimensao territorial: nome, regiao de saude e coordenada",
    "SLV_REGIAO_SAUDE": "as 439 regioes de saude do pais, 62 delas em SP",
...
COLUNA_DESC = {
    ...
    "regiao_saude": "nome da regiao de saude, da Base Territorial do MS",
    "cod_regiao_saude": "CO_REGSAUD, codigo oficial de 5 digitos",
    "nome_municipio": "nome do municipio; o SIH so traz o codigo IBGE",
    "latitude": "graus decimais, sede do municipio — para o mapa",
    "longitude": "graus decimais, sede do municipio — para o mapa",
    "nome_regiao_saude": "nome sem o sufixo ' - UF' que vem no arquivo original",
    "ativa": "S quando a regiao esta vigente (CO_STATUS)",
    "populacao": "PENDENTE — depende do IBGE",
    # Gold
